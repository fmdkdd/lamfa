...
>       'class'         { KW_Class }
>       'data'          { KW_Data }
>       'opendata'      { KW_OpenData }
>       'extenddata'    { KW_ExtendData }
>       'extend'        { KW_Extend }
>       'default'       { KW_Default }
...
>       | srcloc 'opendata' ctype '=' constrs deriving
>                       {% do { (cs,c,t) <- checkDataHeader $3;
>                               return (HsOpenDataDecl $1 cs c t (reverse $5) $6) } }
>       | srcloc 'extenddata' ctype 'where' constrs deriving
>                       {% do { (cs,c,t) <- checkDataHeader $3;
>                               return (HsExtendDataDecl $1 cs c t (reverse $5) $6) } }
