...
module Haskull.Language.Haskell.Syntax (
    -- * Modules
...
data HsDecl
         ...
         | HsOpenDataDecl SrcLoc HsContext HsName [HsName] [HsConDecl] [HsQName]
         | HsExtendDataDecl SrcLoc HsContext HsName [HsName] [HsConDecl] [HsQName]
         ...
         | HsExtendDecl  SrcLoc HsName [HsDecl]
