...
instance (Analyze a _a, Analyze b _b, LeastGen' _a _b c SubstEmpty sout) => 
         LeastGen a b c
...
instance (Analyze a _a, Analyze b _b, LeastGen' _a _b b SubstEmpty sout, Unifies sout a b) 
         => LessGen a b
